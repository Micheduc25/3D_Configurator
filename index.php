    ...
    <aside class="sidebar">
      <div class="sidebar__upper">
        <div class="content-wrapper">
          <div class="logo">
            ...
            <span onclick="toggleMainMenu()" class="toggle-menu-but">&#10095;</span>
          </div>
          <div class="main-menu">
            <div onclick="toggleConfigMenu('maisons',false,event)" class="mainmenu-item maisons">
              <div class="item-title maisons">
                <strong>MODELE DE MAISON</strong>
              </div>
              <div class="item-desc maisons">CHOISIR LA MAISON A CONFIGURER</div>
            </div>
            <div onclick="toggleConfigMenu('enduits',true,event)" class="mainmenu-item">
            ...
            <div onclick="toggleConfigMenu('bardages',true,event)" class="mainmenu-item">
              <div class="item-title">
            ...
            <div onclick="toggleConfigMenu('options',false,event)" class="mainmenu-item">
              <div class="item-title">
      ...
      <div class="sidebar__lower">
        <div class="config-item">
          <a href="https://docs.google.com/document/d/1Kt8zVKYRNJh1hPW9PC-TScNGgysIHul9q4gFG3_ByY4/edit?usp=sharing" style="padding: 5px 0 10px">
            <span></span>
        ...
        <div class="config-details">
          <div class="detail-upper">
            <a href="https://docs.google.com/document/d/1j-zQ5xa9y9XuVEQ7EjVrdSlM_edPeyvLPT6hc3p-_fs/edit?usp=sharing" style="padding: 5px 0 10px">
              <span></span>
          ...
          <div class="toggle-tva">
            <button class="tva-button" onclick="UI.toggleTVA_UI('include',event)">
              Incl. T.V.A
            </button>
            <button class="tva-button selected" onclick="UI.toggleTVA_UI('exclude',event)">
              Excl. T.V.A
            </button>
          </div>
        </div>
      ...
      <div id="config-menu" class="hconfig-menu">
        <div onclick="toggleConfigMenu()" style="margin-bottom: 10px" class="return-but">
          &#10094; Retour
        </div>
    ...
    <div class="partager-popup">
      <div class="popup-wrapper">
        ...
        <div class="popup-social">
          <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2F3d.woodzip.com%2F" class="share-iconbut">
          ...
          <a target="_blank" href="http://twitter.com/intent/tweet?text=Configuration%20de%20la%maison%20Woodzip" class="share-iconbut">
          ...
          <a target="_blank" href="https://wa.me/?text=https://3d.woodzip.com" class="share-iconbut">
          ...
          <a href="mailto:?subject=Configuration%20de%20la%20maison%20Woodzip&amp;body=https://3d.woodzip.com" class="share-iconbut">
        ...
        <div class="popup-link">
          ...
          <input id="link" type="text" readonly="readonly" value="https://3d.woodzip.com" name="link" />
        </div>
